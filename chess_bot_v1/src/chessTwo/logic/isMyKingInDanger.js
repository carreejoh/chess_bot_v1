...
import { whatCanAllPiecesSee } from "./whatCanAllPiecesAttack"
...
// ) => {
    ...
    // let whiteKingStatus = false
    // let blackKingStatus = false
    // let legalMove = true
...
export const isEitherKingInCheck = (
    ...
    // Both kings location
    let whiteKingLocation = whitePieces.whiteKing
    let blackKingLocation = blackPieces.blackKing

    // Find out what pieces can see 
    let allAttacks = whatCanAllPiecesSee(whitePieces, blackPieces, castlingVariables)

    // This move will put your king in check
    if(whitesTurn && allAttacks.allBlackMoves.includes(whiteKingLocation)) {
        return false
    }
    // This move will put your king in check
    if(!whitesTurn && allAttacks.allWhiteMoves.includes(blackKingLocation)) {
        return false
    }
